              ...
              },
              {
                ...
                inputs: {
                  runCommand: [
                    ...
                    `echo 'export JAVA_1_8_HOME=$(update-alternatives --list java | grep "java-1.8.0-amazon-corretto" | head -1)' >> /home/${vsCodeUser}/.bashrc`,
                    ...
                    `echo 'export JAVA_HOME=$(update-alternatives --list java | grep "java-1.8.0-amazon-corretto" | head -1)' >> /home/${vsCodeUser}/.bashrc`,
              ...
              },
              {
                ...
                inputs: {
                  runCommand: [
                    ...
                    `echo 'export JAVA_1_8_HOME=/usr/lib/jvm/java-1.8.0-amazon-corretto' >> /home/${vsCodeUser}/.bashrc`,
                    ...
                    `echo 'export JAVA_HOME=/usr/lib/jvm/java-1.8.0-amazon-corretto' >> /home/${vsCodeUser}/.bashrc`,
                    `echo 'export PATH=$PATH:$JAVA_HOME/bin:/usr/share/maven/bin' >> /home/${vsCodeUser}/.bashrc`,
                    `sudo -u ${vsCodeUser} --login code-server --install-extension vscjava.vscode-java-pack --force`,
                    'echo "Java and Maven installed. Checking configuration"',
                    'java -version 2>&1',
