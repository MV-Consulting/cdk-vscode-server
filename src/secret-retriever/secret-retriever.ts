...
class CustomResourceSecretRetriever extends SecretRetriever {
  constructor(scope: Construct, options: CustomResourceSecretRetrieverOptions) {
    ...
    const onEvent: Function = new SecretRetrieverFunction(scope, 'SecretRetrieverOnEventHandler', {
    ...
    const resource = new CustomResource(scope, 'SecretRetrieverCustomResource', {
